 ...
 * @author sahil
 */
public class AddItemDone extends javax.swing.JFrame {

    /**
     * Creates new form AddItemDone
     */
    public AddItemDone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Item has been added in the list");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(Loader, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(171, 171, 171))
        ...
        setSize(new java.awt.Dimension(573, 372));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void doneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneActionPerformed
        setVisible(false);
        SellerItem backToSale = new SellerItem();
        backToSale.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddItemDone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddItemDone().setVisible(true);
            }
        });
    }
